...
set_property PACKAGE_PIN V10 [get_ports sampleButton]						
	set_property IOSTANDARD LVCMOS33 [get_ports sampleButton]
...
set_property PACKAGE_PIN A13 [get_ports vauxp]				
	set_property IOSTANDARD LVTTL [get_ports vauxp]
##Bank = 15, Pin name = IO_L9N_T1_DQS_AD3N_15,				Sch name = XADC1_N -> XA1_N
set_property PACKAGE_PIN A14 [get_ports vauxn]				
	set_property IOSTANDARD LVTTL [get_ports vauxn]
...
#set_property PACKAGE_PIN A11 [get_ports ampPWM]					
	#set_property IOSTANDARD LVTTL [get_ports ampPWM]
##Bank = 15, Pin name = IO_L6P_T0_15,						Sch name = AUD_SD
#set_property PACKAGE_PIN D12 [get_ports ampSD]						
	#set_property IOSTANDARD LVTTL [get_ports ampSD]
